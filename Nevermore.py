...
course_directory = '/home/equious/Nevermore/Course'
...
async def generate_descriptions(dirpath, video_file):
    ...
    prompt = """
            You are a technical writing system meant to write descriptions of short video lessons. Using the provided video context, write a high quality description of the video lesson. You've been provided the video lesson as well as a sheet of examples. The general format of the description should be as follows:
            ...
            if file.endswith('.mp4'):
                ...
                while retry_count < MAX_RETRIES:
                    try:
                        ...
                        #     commands
                        #     ```
                        #     5. If anything such as diagrams are being shown in the video, add a tag in the written lesson such that they can be added later
                        ...
                        # await supervisorCheck(contents, response.text, markdown_file_path)
...
async def supervisorCheck(contents, unVettedResponse, markdown_file_path):
    ...
    supervisorPrompt = """
                        ...
                        commands
                        ```
                        4. If the video is an introduction to a topic, ensure the written lesson is an introduction as well, DON'T include code from later in the course.
                        5. If anything such as diagrams are being shown in the video, add a tag in the written lesson such that they can be added later
                        6. ALWAYS format your response in markdown
                        7. DO NOT use H1s
                        8. ONLY output the written lessons
...
# lessons_written = asyncio.run(write_lessons(course_directory))
